...
namespace PeliculasAPI.Controllers
{
    ...
    public class CinesController: CustomBaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] CineCreacionDTO cineCreacion)
        {
            return await Post<CineCreacionDTO, Cine, CineDTO>(cineCreacion, "ObtenerCinePorId");
        }
